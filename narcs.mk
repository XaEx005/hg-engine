...
OVERWORLDS_CRYSTAL_SRCS := $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/crystal/*.png) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/crystal/*.json) $(wildcard $(OVERWORLDS_DEPENDENCIES_DIR)/crystal/*.pal)
OVERWORLDS_CRYSTAL_OBJS := $(patsubst $(OVERWORLDS_DEPENDENCIES_DIR)/crystal/%.png,$(OVERWORLDS_DIR)/2_%.btx0,$(OVERWORLDS_CRYSTAL_SRCS))

# add your own overworld sources here
ALL_OVERWORLDS_SRCS := $(OVERWORLDS_SRCS) $(OVERWORLDS_CRYSTAL_SRCS)
ALL_OVERWORLDS_OBJS := $(OVERWORLDS_OBJS) $(OVERWORLDS_CRYSTAL_OBJS)
...
$(OVERWORLDS_DIR)/2_%.btx0:$(OVERWORLDS_DEPENDENCIES_DIR)/crystal/%.png $(OVERWORLDS_DEPENDENCIES_DIR)/crystal/%.json $(OVERWORLDS_DEPENDENCIES_DIR)/crystal/%*.pal
	$(BTX) $< $@
