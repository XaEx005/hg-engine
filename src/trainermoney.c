...
struct TrainerMoney PrizeMoney[] = // 0x34C04 in Overlay 12; 2 bytes for trainer class ID, 2 bytes for modifier; 516 bytes in total in vanilla
{
    ...
    { .class = TRAINERCLASS_PKMN_TRAINER_LANCE, .multiplier = 30 },
    ...
    { .class = TRAINERCLASS_CHAMPION_CRYSTAL, .multiplier = 50 },
    { .class = TRAINERCLASS_ELITE_FOUR_EUSINE, .multiplier = 30 },
