...
u16 MainMusicComboTable[][2] =
{
    ...
    [ANIM_MUSIC_COMBO_WILL] = {0x1D, SEQ_GS_VS_GYMREADER_KANTO},
    [ANIM_MUSIC_COMBO_KOGA] = {0x1E, SEQ_GS_VS_GYMREADER_KANTO},
    [ANIM_MUSIC_COMBO_BRUNO] = {0x1F, SEQ_GS_VS_GYMREADER_KANTO},
    [ANIM_MUSIC_COMBO_KAREN] = {0x20, SEQ_GS_VS_GYMREADER_KANTO},
    ...
    [ANIM_MUSIC_COMBO_CRYSTAL] = {0xFFFF, SEQ_GS_VS_CHAMP},
    [ANIM_MUSIC_COMBO_EUSINE] = {0x1E, SEQ_GS_VS_GYMREADER_KANTO},
    [ANIM_MUSIC_COMBO_AGATHA] = {0x1F, SEQ_GS_VS_GYMREADER},
    [ANIM_MUSIC_COMBO_LORELEI] = {0x20, SEQ_GS_VS_GYMREADER},
};
...
u8 TrainerClassToMusicCombo[][2] =
{
    ...
    {TRAINERCLASS_CHAMPION, ANIM_MUSIC_COMBO_RED*4},
    ...
    // (***END OF VANILLA ENTRIES***)
    {TRAINERCLASS_CHAMPION_CRYSTAL, ANIM_MUSIC_COMBO_LANCE*4},
    {TRAINERCLASS_ELITE_FOUR_EUSINE, ANIM_MUSIC_COMBO_EUSINE*4},
    {TRAINERCLASS_ELITE_FOUR_AGATHA, ANIM_MUSIC_COMBO_AGATHA*4},
...
struct TrainerMusic sTrainerEncounterMusicParam[] = // cues which music sequence occurs upon eyes meeting
{
    ...
    {.class = TRAINERCLASS_PSYCHIC_M, .music1 = SEQ_GS_EYE_BOUZU, .music2 = SEQ_GS_EYE_BOUZU},
    ...
    {.class = TRAINERCLASS_PSYCHIC_F, .music1 = SEQ_GS_EYE_BOUZU, .music2 = SEQ_GS_EYE_BOUZU},
    {.class = TRAINERCLASS_WAITER, .music1 = SEQ_GS_EYE_K_SHOUNEN, .music2 = SEQ_GS_EYE_K_SHOUNEN},
    {.class = TRAINERCLASS_PARASOL_LADY, .music1 = SEQ_GS_EYE_K_SHOUJO, .music2 = SEQ_GS_EYE_K_SHOUJO},
    {.class = TRAINERCLASS_WORKER, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_RUIN_MANIAC, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_SOCIALITE, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_LADY, .music1 = SEQ_GS_EYE_K_SHOUJO, .music2 = SEQ_GS_EYE_K_SHOUJO},
    {.class = TRAINERCLASS_RICH_BOY, .music1 = SEQ_GS_EYE_K_SHOUNEN, .music2 = SEQ_GS_EYE_K_SHOUNEN},
    {.class = TRAINERCLASS_BIRD_KEEPER, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
    {.class = TRAINERCLASS_JOGGER, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_POKE_KID, .music1 = SEQ_GS_EYE_J_SHOUNEN, .music2 = SEQ_GS_EYE_J_SHOUNEN},
    {.class = TRAINERCLASS_COWGIRL, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
    {.class = TRAINERCLASS_RANCHER, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_ARTIST, .music1 = SEQ_GS_EYE_J_AYASHII, .music2 = SEQ_GS_EYE_J_AYASHII},
    {.class = TRAINERCLASS_AROMA_LADY, .music1 = SEQ_GS_EYE_K_SHOUJO, .music2 = SEQ_GS_EYE_K_SHOUJO},
    {.class = TRAINERCLASS_DRAGON_TAMER, .music1 = SEQ_GS_EYE_K_AYASHII, .music2 = SEQ_GS_EYE_K_AYASHII},
    {.class = TRAINERCLASS_BATTLE_GIRL, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
    {.class = TRAINERCLASS_PKMN_RANGER_M, .music1 = SEQ_GS_EYE_J_SHOUNEN, .music2 = SEQ_GS_EYE_J_SHOUNEN},
    {.class = TRAINERCLASS_PKMN_RANGER_F, .music1 = SEQ_GS_EYE_J_SHOUJO, .music2 = SEQ_GS_EYE_J_SHOUJO},
    {.class = TRAINERCLASS_PKMN_BREEDER_M, .music1 = SEQ_GS_EYE_J_SHOUNEN, .music2 = SEQ_GS_EYE_J_SHOUNEN},
    {.class = TRAINERCLASS_PKMN_BREEDER_F, .music1 = SEQ_GS_EYE_K_SHOUJO, .music2 = SEQ_GS_EYE_K_SHOUJO},
};
